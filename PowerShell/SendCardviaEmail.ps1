$cardJson = Get-Content C:\Git\AdaptiveCardsDemo\PowerShell\expenseCard.json
...
Send-MailMessage –From $msolcred.UserName –To $msolcred.UserName `
    -Subject "MessageCard Demo" `
    -Body $htmlMessage -BodyAsHtml `
